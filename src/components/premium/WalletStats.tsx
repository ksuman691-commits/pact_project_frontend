...
export default function WalletStats({ balance, locked, earned, pending }: WalletStatsProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      {/* Total Balance */}
      <PremiumCard glass className="bg-white border-blue-200">
      ...
      {/* Available */}
      <PremiumCard glass className="bg-white border-emerald-200">
        <div className="flex items-start justify-between mb-2">
      ...
      {/* Locked */}
      <PremiumCard glass className="bg-white border-orange-200">
        <div className="flex items-start justify-between mb-2">
      ...
      {/* Earned */}
      <PremiumCard glass className="bg-white border-amber-200">
        <div className="flex items-start justify-between mb-2">
